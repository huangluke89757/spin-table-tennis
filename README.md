...
**平板横屏可直接玩；手机竖屏会提示横置设备** —— 这不是偷懒，是几何上不成立：

<div align="center">

<img src="docs/images/11-phone-portrait.png" width="300" alt="手机竖屏：请横置设备的引导层">

<sub>手机竖屏 —— 引导层完全遮断对局，避免玩家在看不到球台的情况下瞎按</sub>

</div>

第一视角相机垂直视角固定 **40°**。竖屏时水平视角只剩 **19.1°**，击球位置的可视半宽仅 **0.239m**，
而球台半宽是 **0.7625m** —— 球还没飞到能被看见的位置就已经出画了。横屏水平视角 **76.5°**，
可视半宽 **1.118m**，球台完整入画。所以竖屏给引导、不给一个看不见球的对局。
